...
/*
This code was written and used by the class instructor as a way to grade our
Lab9.sql code. It was supplied to students to use during the assignment as
a way to test the code ourselves.
*/



USE Instructor -- Instructor database account area for SalesDB

BEGIN
    DECLARE @v_now DATETIME
    SET @v_now = GETDATE()
    PRINT CHAR(10) + '*****************************************************';
    PRINT '*  Lab9 using SQL Server 2012 graded on ' + CONVERT(CHAR(12), @v_now, 101) + '*';
    PRINT '*****************************************************';
...
PRINT '=====================================================' + CHAR(10);
EXECUTE Lab9proc 9, 9999, 1010, 9;
GO
...
PRINT '=====================================================' + CHAR(10);
EXECUTE Lab9proc 1, 9999, 1010, 9;
GO
...
PRINT '=====================================================' + CHAR(10);
EXECUTE Lab9proc 21, 6099, 1010, 9;
GO
...
PRINT '=====================================================' + CHAR(10);
EXECUTE Lab9proc 1, 6099, 9999, 9;
GO
...
PRINT '=====================================================' + CHAR(10);
EXECUTE Lab9proc 1, 6099, 1001, 0;
GO
...
PRINT '=====================================================' + CHAR(10);
EXECUTE Lab9proc 1, 6099, 1001, -1;
GO
...
PRINT 'EXECUTE Lab9proc 1, 6099, 1001, 200'
EXECUTE Lab9proc 1, 6099, 1001, 200;
GO
...
SELECT * FROM INVENTORY WHERE PartID = 1001;
SELECT * FROM ORDERITEMS WHERE OrderID = 6099;
PRINT 'EXECUTE Lab9proc 1, 6099, 1001, 100';
EXECUTE Lab9proc 1, 6099, 1001, 100;
GO
PRINT CHAR(10) + 'INVENTORY AND ORDERITEMS AFTER TEST'
SELECT * FROM INVENTORY WHERE PartID = 1001;
SELECT * FROM ORDERITEMS WHERE OrderID = 6099;
...
SELECT * FROM INVENTORY WHERE PartID = 1001;
SELECT * FROM ORDERITEMS WHERE OrderID = 6099;
PRINT 'EXECUTE Lab9proc 1, 6099, 1001, 9';
EXECUTE Lab9proc 1, 6099, 1001, 9;
GO
...
SELECT * FROM ORDERITEMS WHERE OrderID = 6099;
PRINT 'EXECUTE Lab9proc 1, 6099, 1002, 29';
EXECUTE Lab9proc 1, 6099, 1002, 29;
GO
PRINT CHAR(10) + 'INVENTORY AND ORDERITEMS AFTER TEST'
SELECT * FROM INVENTORY WHERE PartID = 1002;
SELECT * FROM ORDERITEMS WHERE OrderID = 6099;
...
PRINT 'EXECUTE Lab9proc 15, 6107, 1003, 10';
EXECUTE Lab9proc 15, 6107, 1003, 10;
GO
PRINT CHAR(10) + 'INVENTORY AND ORDERITEMS AFTER TEST'
SELECT * FROM INVENTORY WHERE PartID = 1003;
SELECT * FROM ORDERITEMS WHERE OrderID = 6107;
